...
for filename in os.listdir('./Train/'):
    ...
    # Xtemp = cv.filter2D(Xtemp, -1, kernel=kernel)
    X.append(Xtemp)
...
encoder_output = Conv2D(512, (3, 3), activation='relu', padding='same')(encoder_output)
encoder_output = Conv2D(256, (3, 3), activation='relu', padding='same')(encoder_output)
encoder_output1=encoder_output#保存这里卷积的结果，后面concatenate
# 64 64 256
...
encoder_output=Conv2D(256,(3,3),activation='relu',padding='same')(encoder_output)
encoder_output=BatchNormalization()(encoder_output)
encoder_output = UpSampling2D((2, 2))(encoder_output)
#32 32 256
...
#concatenate
encoder_output=concatenate([encoder_output1,encoder_output],axis=3)
#64 64 512

encoder_output=Conv2D(256,(1,1),activation='relu',padding='same')(encoder_output)
# print(encoder_output.shape)
#? 64 64 256
# 类似于vgg16的卷积结束
...
#inception
tower_1=Conv2D(64,(1,1),padding='same',activation='relu')(fusion_output)
tower_1=Conv2D(64,(3,3),padding='same',activation='relu')(tower_1)
#64 64 64

tower_2=Conv2D(64,(1,1),padding='same',activation='relu')(fusion_output)
tower_2=Conv2D(64,(5,5),padding='same',activation='relu')(tower_2)
#64 64 64

tower_3=MaxPooling2D((3,3),strides=(1,1),padding='same')(fusion_output)
# print(tower_3.shape) 64 64 256
tower_3=Conv2D(64,(1,1),padding='same',activation='relu')(tower_3)
# print(tower_3.shape) 64 64 64

fusion_output=concatenate([tower_1,tower_2,tower_3],axis=3)
# print(fusion_output.shape) 64 64 192
